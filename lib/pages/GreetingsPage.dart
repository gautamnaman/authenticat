import 'package:authenticat/pages/SetMasterPassword.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text("Welcome to Authenticat!",
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(24.0, 8, 24, 8),
                child: Text(
                  "Authenticat takes care of your sensitive password data using AES encryption.",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontFamily: "Subtitle",
                    fontSize: 18,
